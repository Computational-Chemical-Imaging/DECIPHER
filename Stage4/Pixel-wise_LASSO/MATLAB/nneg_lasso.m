...
fprintf('Iter \t residualC \t residualv \t residualu \t residualFit \n');
for ii = 1:iter
    C_old    = C;
    vhat_old = vhat;
    u_old    = u;
    ...
    fit_error = norm(y(:) - y_recon(:)) / norm(y_recon(:));

    fprintf('%3g \t %3.5e \t %3.5e \t %3.5e \t %3.5e \n', ii, residualC, residualvhat, residualu, fit_error);
