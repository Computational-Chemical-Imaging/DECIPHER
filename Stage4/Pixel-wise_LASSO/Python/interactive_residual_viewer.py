...
def interactive_residual_viewer(y, y_recon, wn=None, proj_method="mean"):
    ...
    Click one point on the residual map, then the original,
    reconstructed, and residual spectra will be plotted.
    ...
    ax.set_title("Residual map: click a point, press Enter to stop")
    ax.axis("image")
